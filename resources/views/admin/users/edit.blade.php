        ...
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dealer_code') ? 'is-invalid' : '' }}" type="text"
                    name="dealer_code" id="dealer_code" value="{{ old('dealer_code', $user->dealer_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('endpoint') ? 'is-invalid' : '' }}" type="text"
                    name="endpoint" id="endpoint" value="{{ old('endpoint', $user->endpoint) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_id') ? 'is-invalid' : '' }}" type="number"
                    name="company_id" id="company_id" value="{{ old('company_id', $user->company_id) }}" step="1"
                    required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('next_schedule') ? 'is-invalid' : '' }}" type="text"
                    name="next_schedule" id="next_schedule" value="{{ old('next_schedule', $user->next_schedule) }}"
                    required>
