...
{
    protected static $company_idEnSuffix = [
        'Inc', 'and Sons', 'LLC', 'Group', 'PLC', 'Ltd',
    ];

    protected static $company_idEnFormats = [
        '{{lastNameEn}} {{company_idEnSuffix}}',
        '{{lastNameEn}}-{{lastNameEn}}',
        '{{lastNameEn}}, {{lastNameEn}} and {{lastNameEn}}',
    ];

    protected static $formats = [
        '{{company_idPrefix}}{{company_idModifier}}',
        '{{company_idPrefix}}{{company_idSuffix}}',
        '{{company_idPrefix}}{{company_idModifier}}{{CompanySuffix}}',
    ];
    ...
    protected static $company_idModifier = [
    ...
    public static function company_idEnSuffix()
    {
        return static::randomElement(static::$company_idEnSuffix);
    }

    public function company_idEn()
    {
        $format = static::randomElement(static::$company_idEnFormats);

        return $this->generator->parse($format);
    }

    public static function company_idModifier()
    {
        return static::randomElement(static::$company_idModifier);
    }
