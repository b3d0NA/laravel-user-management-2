...

{
    protected static $formats = [
        ...
        '{{lastName}}, {{lastName}} y {{lastName}} {{company_idSuffix}}',
        '{{lastName}}-{{lastName}}',
        '{{lastName}} y {{lastName}}',
    ...
    protected static $company_idPrefix = ['Asociación', 'Centro', 'Corporación', 'Empresa', 'Gestora', 'Global', 'Grupo', 'Viajes', 'Air'];
    protected static $company_idSuffix = ['e Hijo', 'e Hija', 'e Hijos', 'y Asoc.', 'y Flia.', 'SRL', 'SA', 'S. de H.'];
