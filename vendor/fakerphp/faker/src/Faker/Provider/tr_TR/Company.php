...

{
    protected static $formats = [
        ...
        '{{lastName}}oğlu {{company_idSuffix}}',
        '{{lastName}} {{lastName}} {{company_idSuffix}}',
        '{{lastName}} {{company_idField}} {{company_idSuffix}}',
        '{{lastName}} {{company_idField}} {{company_idSuffix}}',
        '{{lastName}} {{company_idField}} {{company_idSuffix}}',
        '{{lastName}} {{lastName}} {{company_idField}} {{company_idSuffix}}',
    ];

    protected static $company_idSuffix = ['A.Ş.', 'Ltd. Şti.'];
    ...
    /**
     * Returns a random company_id field.
     *
     * @return string
     */
