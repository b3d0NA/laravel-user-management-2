...

{
    protected static $formats = [
        '{{company_idName}}', // Вектор
        '{{company_idPrefix}} "{{company_idName}}"', // ТОВ "Інфоком"
        '{{company_idName}}-{{company_idSuffix}}', // Сервіс-Плюс
        '{{company_idPrefix}} "{{company_idName}}-{{company_idSuffix}}"', // ПАТ "Альфа-Стиль"
    ];
    ...
    protected static $company_idPrefix = ['ТОВ', 'ПП', 'ПАТ', 'ПрАТ'];
    protected static $company_idSuffix = ['Сервіс', 'Плюс', 'Груп', 'Стиль', 'Дизайн'];

    protected static $company_idName = [
    ...
    {
        return static::randomElement(static::$company_idName);
    }
}
