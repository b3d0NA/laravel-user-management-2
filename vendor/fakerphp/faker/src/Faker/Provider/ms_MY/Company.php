...

{
    protected static $formats = [
        '{{company_idName}} {{company_idSuffix}}',
        '{{industry}} {{lastNameMalay}} {{company_idSuffix}}',
        '{{industry}} {{firstNameMaleChinese}} {{company_idSuffix}}',
        '{{industry}} {{firstNameMaleIndian}} {{company_idSuffix}}',
    ];
    ...
    /**
     * Return a random company_id name
     *
     * @example 'AirAsia'
     */
